...
package asgard.net 
{
    ...
    public class NetStreamClient extends CoreEventDispatcher implements INetStreamClient
    {
         ...
         */
        public function NetStreamClient( netStream:NetStream = null , bGlobal:Boolean = false , sChannel:String = null ) 
        {
        ...
        protected function netStatus( e:NetStatusEvent ):void
        {
            if ( verbose )
            {
                getLogger().info( this + " netStatus, code:" + e.info.code + " level:" + e.info.level ) ;
            }
            onStatus( e.info ) ;
            dispatchEvent(e) ;
        }        
