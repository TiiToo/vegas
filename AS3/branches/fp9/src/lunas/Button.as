...
package lunas
{
     ...
     */
    public interface Button extends Data, Focusable, Labelable
    {
        /**
         ...
         * @param options The optional flag to control the method (default null).
         */
        function setSelected ( b:Boolean, options:* = null ):void 
    }
}
