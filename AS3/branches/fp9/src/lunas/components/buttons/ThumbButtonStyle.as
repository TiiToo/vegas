...
package lunas.components.buttons
{
    ...
    public class ThumbButtonStyle extends LightButtonStyle 
    {
         ...
         */
        public function ThumbButtonStyle( init:* = null , id:* = null )
        {
            super( init , id );
        ...
        {
            tweenOver     = new TweenTo(null, { brightness : 0 } , Expo.easeOut, 1, true , false, { brightness : 70 } ) ;
            tweenSelected = new TweenTo(null, { brightness : 0 } , Expo.easeOut, 1, true , false, { brightness : 125 } ) ;
        }
    }
}
