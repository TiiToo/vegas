...
package lunas.components.buttons 
{
    ...
    public class ItemButtonBuilder extends IconButtonBuilder 
    {
        ...
        public override function update():void 
        {
            ...
            if ( s.margin )
            {
                mb = replaceNaN( s.margin.bottom ) ;
                ml = replaceNaN( s.margin.left   ) ;
                mr = replaceNaN( s.margin.right  ) ;
                mt = replaceNaN( s.margin.top    ) ;
            }
            
            if ( s.padding )
            {
                pb = replaceNaN( s.padding.bottom ) ;
                pl = replaceNaN( s.padding.left   ) ;
                pr = replaceNaN( s.padding.right  ) ;
                pt = replaceNaN( s.padding.top    ) ;
            }
