...
package lunas.components.buttons
{
    ...
    public class SwitchLabelButtonStyle extends BackgroundButtonStyle 
    {
        ...
        /**
         * Indicates if the component use the switch effect.
         */
        public var useSwitch:Boolean = true ;
        ...
        public override function initialize():void 
        {
            ...
            tweenSelected = new TweenTo( null , { brightness : 0 } , Elastic.easeOut , 0.75 , true  , false, { brightness : 60  } ) ;
        }
    }
}
