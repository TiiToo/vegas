...
package lunas.components.buttons 
{
    ...
    public class LabelButtonBuilder extends BackgroundButtonBuilder 
    {
        ...
        public override function update():void 
        {
            ...
            if ( b  && s )
            {
                field.x      = replaceNaN( s.padding.left ) + replaceNaN( s.margin.left ) ;
                field.y      = replaceNaN( s.padding.top )  + replaceNaN( s.margin.top  ) ;
                if ( s.autoSize )
                {
                    refreshField()  ;
                    field.width  = field.textWidth ;
                    field.height = field.textHeight ;
                    b.hack::_w = field.width  + replaceNaN( s.padding.horizontal ) + replaceNaN( s.margin.horizontal ) ;
                    b.hack::_h = field.height + replaceNaN( s.padding.vertical   ) + replaceNaN( s.margin.vertical   ) ;
                    refreshBackground() ;
                }
                else
                {
        ...
        protected function refreshField():void
        {
            ...
            if ( b  && s )
            {
                ...
                field.width         = b.w - replaceNaN( s.padding.horizontal ) - replaceNaN( s.margin.horizontal ) ;
                field.height        = b.h - replaceNaN( s.padding.vertical   ) - replaceNaN( s.margin.vertical   ) ;
