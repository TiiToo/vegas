    ...
    public class IconButtonBuilder extends LabelButtonBuilder 
    {
        ...
        protected function refreshContainer():void
        {
            if ( container != null )
            {
                ...
                var ml:Number = replaceNaN( s.margin.left ) ;
                var mr:Number = replaceNaN( s.margin.right ) ;
                var pb:Number = replaceNaN( s.padding.bottom ) ;
                var pl:Number = replaceNaN( s.padding.left ) ;
                var pr:Number = replaceNaN( s.padding.right ) ;
                var pt:Number = replaceNaN( s.padding.top ) ;
                
                if ( s.iconAlign == Align.RIGHT )
                {
