    ...
    public class PaginationLabelBuilder extends LabelBuilder 
    {
        ...
        public function getFieldText():String
        {
            ...
            if ( b && p && pages )
            {
                ...
                {
                    o.previous = format( s.previousPattern, p.currentPage - 1 , b.previousLabel ) ; 
                }
                o.body = "" ;
                var i:uint ;
                ...
                {
                    o.next = format( s.nextPattern , p.currentPage + 1 , b.nextLabel ) ;
                }
                
                if( p.currentPage < p.totalPage && b.lastLabel != null && b.lastLabel.length > 0 )
                {
                    o.last = format( s.lastPattern, p.totalPage , b.lastLabel ) ; 
                }
        ...
        protected override function refreshFieldLayout():void
        {
            ...
            field.height = t.h - ( replaceNaN( s.padding.vertical ) ) ;
            field.width = t.w - field.x - ( replaceNaN(s.padding.horizontal) ) ;
            field.x = replaceNaN(s.padding.left) ;
