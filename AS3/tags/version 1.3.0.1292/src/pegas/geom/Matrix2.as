...
package pegas.geom 
{
    ...
    public class Matrix2 implements Geometry 
    {
        ...
        public function Matrix2( ...arguments:Array )
        {
            ...
            {
                Matrix2Util.setByVector( this , arguments[0] as Vector2 , arguments[1] as Vector2 ) ;
            }
            else if ( arguments[0] is Matrix2 )
            {
                Matrix2Util.setByMatrix(this, arguments[0] as Matrix2) ;    
            }
            else if ( arguments[0] is Number )
            {
            	Matrix2Util.setByAngle(this, arguments[0] as Number) ;
            }
            else
            {
                identity() ;
