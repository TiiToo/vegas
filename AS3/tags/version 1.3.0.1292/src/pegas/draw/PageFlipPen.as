...
package pegas.draw 
{
    ...
    {    
         ...
         * <ul>
         */
        public static function compute( drag:Point, corner:Point, w:int, h:int, ish:Boolean, sens:int):Object
        {
            var temp:Number;
            ...
            _ordMatrix( mat, spt, opw, oph, ish, cPoints, pPoints, gama, beta );
         ...
         * @private
         */
        private static function _ordMatrix( mat:Matrix, spt:Point, w:Number, h:Number, ish:Boolean, cPoints:Array, pPoint:Array, gama:Number, beta:Number):void
        {
            if (spt.x == 1 && spt.y == 0)
            {
                mat.tx = cPoints[0].x;
