...
package andromeda.events
{
    ...
    public class ModelObjectEvent extends BasicEvent
    {
         ...
         */    
        public function ModelObjectEvent(type:String, model:IModelObject=null , vo:ValueObject=null, target:Object = null , context:* = null, bubbles:Boolean=false, cancelable:Boolean=false , time:Number = 0 )
        {
