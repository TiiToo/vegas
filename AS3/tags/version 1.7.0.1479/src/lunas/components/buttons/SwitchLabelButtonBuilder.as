...
package lunas.components.buttons
{
    ...
    public class SwitchLabelButtonBuilder extends BackgroundButtonBuilder 
    {
        ...
        public override function update():void
        {
            ...
            var txt1:String = HTMLFormatter.paragraph( d.label || "", s.labelStyleName ) ;
            
            var txt2:String = d.selectLabel ;
            if (txt2 == null)
            {
                txt2 = d.label || "" ;
            }
            ...
            _refreshField( field1 , txt1, 0 ) ;
            _refreshField( field2 , txt2 , - field1.height ) ;
            
            if ( s.useTextColor )
            {
                field1.textColor = d.selected ? s.textRollOverColor : s.color ;
                field2.textColor = s.textRollOverColor ;
            }
            
            if ( d )
            {
                d.w = field1.width + s.padding.left ;
            }
         ...
         * @private
         */
        private function _refreshContainers():void
        {
            var d:SwitchLabelButton = target as SwitchLabelButton ;
            var s:SwitchLabelButtonStyle = d.style as SwitchLabelButtonStyle ;
         ...
         * @private
         */
        private function _refreshField( field:TextField, txt:String, offsetY:Number ):void
        {
            var d:SwitchLabelButton = target as SwitchLabelButton ;
            var s:SwitchLabelButtonStyle = d.style as SwitchLabelButtonStyle ;
            if ( field && s )
