...
{
    /**
     * The SwitchLabelButton button component.
     */
    public class SwitchLabelButton extends BackgroundButton 
    {
        /**
         * Creates a new SwitchLabelButton instance.
         ...
         */ 
        public function SwitchLabelButton( w:Number = 120 , h:Number = 20 , id:* = null, isFull:Boolean=false, name:String = null )
        {
        ...
        {
            return SwitchLabelButtonBuilder ;
        }
