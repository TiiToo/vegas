        ...
        public function down( e:ButtonEvent ):void
        {
            ...
            if ( s != null )
            {
                if ( s.useEasingSelected )
                {
                    ...
                    _tw.addProperty( s.easingSelectedProperty, s.easingSelected, s.easingSelectedBegin, s.easingSelectedFinish ) ;
                    _tw.run() ;
                }
            }
        }
        ...
        public function over( e:ButtonEvent ):void
        {
            ...
            if ( s != null )
            {
                if ( s.useEasingOver )
                {
                    ...
                    _tw.addProperty( s.easingOverProperty, s.easingOver, s.easingOverBegin, s.easingOverFinish ) ;
                    _tw.run() ;
                }
            }
        }
