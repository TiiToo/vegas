...
package andromeda.model.map 
{
    ...
    public class MapModel extends AbstractModelObject implements Iterable 
    {
         ...
         * @throws Warning if the <code class="prettyprint">ValueObject</code> passed in argument is already register in the model.
         */
        public function addVO( vo:ValueObject ):void
        {
            ...
            {
                throw new Warning( this + " addVO method failed, the ValueObject passed in argument already register in the model, you must remove this 'id' key before add a new value object.") ;    
            }
        }
