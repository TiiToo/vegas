...
package pegas.draw 
{
    ...
    import pegas.geom.Lines;
    import pegas.geom.Vectors2;
    ...
    public class ArrowPen extends LinePen 
    {
        ...
        public override function drawShape():void
        {
            ...
            if ( start.equals(end) == false )
            {
                ...
                var full:Vector2 = Vectors2.getSubstraction(end, start) ;
                ...
                Vectors2.normalize( sNorm, shaftThickness / 2 ) ;
                
                var s1:Vector2 = Vectors2.getAddition(start , sNorm) ;
                var s2:Vector2 = Vectors2.getSubstraction( start , sNorm ) ;
                
                var e1:Vector2 = Vectors2.getAddition(end , sNorm) ;
                var e2:Vector2 = Vectors2.getSubstraction( end , sNorm ) ;
                
                // phase 2
                
                var head:Vector2 = full.clone();
                
                Vectors2.normalize( head ,  Vectors2.getLength( head ) - headSize ) ;
                
                Vectors2.addition( head , start ) ;
                
                // phase 3
                
                var headNorm:Vector2 = sNorm.clone();
                
                Vectors2.normalize( headNorm, halfWidth ) ;
                
                var edge1:Vector2 = Vectors2.getAddition( head , headNorm ) ;
                var edge2:Vector2 = Vectors2.getSubstraction( head , headNorm ) ;
                ...
                var shaftCenter:Vector2 = Vectors2.interpolate( end ,head , shaftPosition ) ;
                ...
                var edgeCenter:Vector2 = Vectors2.interpolate( end ,head , edgeControlPosition ) ;                
                
                var edgeNorm:Vector2   = sNorm.clone();
                
                Vectors2.normalize( edgeNorm , halfWidth * edgeControlSize ) ;                
                
                var edgeCtrl1:Vector2 = Vectors2.getAddition( edgeCenter , edgeNorm ) ;
                var edgeCtrl2:Vector2 = Vectors2.getSubstraction( edgeCenter , edgeNorm ) ;                
