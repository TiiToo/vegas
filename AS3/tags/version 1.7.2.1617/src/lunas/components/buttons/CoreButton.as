    ...
    public dynamic class CoreButton extends CoreComponent implements Button 
    {
        ...
        public override function set buttonMode( b:Boolean ):void 
        {
            ...
            if ( _scope != null && _scope != this )
            {
                ...
                (_scope as Sprite).buttonMode = _buttonMode ;
            }
            else
            {
        ...
        public override function set useHandCursor( b:Boolean ):void 
        {
            ...
            {
                (_scope as Sprite).useHandCursor = false ;
         ...
         */
        public override function registerView( scope:DisplayObjectContainer = null ):void
        {
            super.registerView( scope ) ;
            if( _scope )
            {
                (_scope as Sprite).buttonMode    = buttonMode ;
                _scope.mouseEnabled  = mouseEnabled ;
                (_scope as Sprite).useHandCursor = useHandCursor ;
                if ( enabled )
                {
                    _registerScope() ;
                }
         ...
         */
        public override function unregisterView():void
        {
            if ( _scope ) 
            {
                (_scope as Sprite).buttonMode    = false ;
                (_scope as Sprite).useHandCursor = false ;
