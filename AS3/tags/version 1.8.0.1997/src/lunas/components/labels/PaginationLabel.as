...
package lunas.components.labels 
{
    ...
    /**
     * The pagination title component.
     */
    public class PaginationLabel extends Label
    {
         ...
         */
        public function PaginationLabel( w:Number = 610 , h:Number = 22 , id:* = null, isFull:Boolean=false, name:String = null )
        {
            lock() ;
        ...
        protected function keyDown( e:KeyboardEvent = null ):void
        {
            ...
            // getlogger().info( this + " key down : " + pagination.currentPage + " : " + pagination.totalPage + " ::: " + stage.focus ) ;
