    ...
    public class CoreComponent extends Background implements Component
    {
        ...
        public function set layout( layout:Layout ):void
        {
            if ( _layout )
            {
                ...
                _layout.renderer.disconnect( updateLayout ) ;
            }
            _layout = layout ;
            if ( _layout )
            {
                _layout.renderer.connect( renderLayout ) ;
                _layout.renderer.connect( updateLayout ) ;
        ...
        public override function update():void 
        {
            ...
            {
                _layout.container = _scope ;
                _layout.align     = this.hack::_align  ;
                _layout.run() ;
            }
            draw() ;
            if ( _builder != null ) 
        ...
        /**
         * Register the Style reference of the component.
         */
        ...
        /**
         * Unregister the Style reference of the component.
         */
