...
package lunas.core 
{
    ...
    public class AbstractComponent extends CoreSprite implements IComponent
    {
         ...
         */
        public function AbstractComponent( id:* = null, name:String = null)
        {
            ...
            if ( cs != null && Reflection.getClassInfo(cs).hasInterface(IStyle) ) 
            {
                ...
                {
                    style = new cs() as IStyle ;
                    if ( style )
                    {
                        style.id = path ; // creates the default singleton IStyle reference of this component
                    }
                }
            }
        }
        ...
        /**
         * Indicates the virtual height value of this component.
         */
        ...
        /**
         * Indicates the virtual width value of this component.
         */
