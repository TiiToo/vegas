...
package pegas.colors 
{
    ...
    public class SolidColor extends Color 
    {
        ...
        {
            var t:Object = getTransform() ;
            setRGB ( Colors.RGB2Number(t.rb, t.gb, amount) ) ;
        }
        ...
        {
            var t:Object = getTransform();
            setRGB ( Colors.RGB2Number(t.rb, amount, t.bb) ) ;
        }
        ...
        {
            var t:Object = getTransform();
            setRGB ( Colors.RGB2Number(amount, t.gb, t.bb) ) ;
        }
        ...
        { 
            setRGB( Colors.RGB2Number(r,g,b) ) ; 
        }
