...
package pegas.geom 
{
    ...
    public class Beziers 
    {
        ...
        public static function createBezier(step:Number ,points:Array ,precision:Number=0, loop:Boolean=true):Array 
        {
            ...
            while (i<nbp)
            {
                ...
                while (t<=1)
                {
                    ...
                    if ( lastpoint != null ) 
                    {
                        if ( Vectors2.getDistance(lastpoint,npoint) > precision )
                        {
                            lastpoint=npoint;
                            pts.push(npoint);
                        }
        ...
        {
            var p0_1:Vector2 = Lines.getMiddle(p0, p1) ;
            var p1_2:Vector2 = Lines.getMiddle(p1, p2);
            var p2_3:Vector2 = Lines.getMiddle(p2, p3);
            var p0_2:Vector2 = Lines.getMiddle(p0_1, p1_2);
            var p1_3:Vector2 = Lines.getMiddle(p1_2, p2_3);
            var p0_3:Vector2 = Lines.getMiddle(p0_2, p1_3);
            var o:Object = 
            {
