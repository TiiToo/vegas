...
package andromeda.ioc.io 
{
    ...
    import andromeda.logging.logger;
     ...
     */
    public class TextResource extends ObjectResource 
    {
        /**
         * Creates a new TextResource instance.
         * @param init A generic object containing properties with which to populate the newly instance. If this argument is null, it is ignored.
         */
        public function TextResource( init:Object = null )
        {
            super( init ) ;
        ...
        public override function initialize( ...args:Array ):void
        {
            if ( _definition != null )
            {
                _definition.setFactoryStrategy( new ObjectFactoryValue( _loader.data as String ) ) ;
            }
            else
            {
