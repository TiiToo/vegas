    ...
    public class ObjectFactory extends ObjectDefinitionContainer implements Factory, Identifiable, IObjectFactory
    {
        ...
        private function _initialize( instance:* , definition:IObjectDefinition ):*
        {
            if ( instance != null && definition != null )
            {
                ...
                if ( flag )
                {
                    (instance as Lockable).lock() ;
                }
                
                populateProperties( instance , definition.getProperties() ) ;
                registerListeners( instance , definition.getListeners() ) ; // TEST after the method populateProperties
                
                if ( flag )
                {
                    (instance as Lockable).unlock() ;
                }
