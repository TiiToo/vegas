...
package andromeda.model.queue 
{
    ...
    public class QueueModelObject extends CoreModelObject 
    {
         ...
         */ 
        public function QueueModelObject(id:* = null, global:Boolean = false, channel:String = null)
        {
        ...
        /**
         * Notify a {@code ModelObjectEvent} when a {@code ValueObject} is dequeue in the model.
         */ 
        ...
        /**
        * Notify a {@code ModelObjectEvent} when a {@code ValueObject} is enqueue in the model.
        */ 
