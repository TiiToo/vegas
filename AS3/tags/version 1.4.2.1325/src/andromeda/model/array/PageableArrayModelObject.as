...
package andromeda.model.array 
{
     ...
     * import andromeda.events.ModelObjectEvent ;
     * import andromeda.model.array.PageableArrayModelObject ;
     * import andromeda.vo.SimpleValueObject ;
     * 
     * import vegas.events.ArrayEvent ;
     * 
     * var onUpdate:Function = function( e:Event ):void
     * {
     *     switch( true )
     *     {
     ...
     * model.count =  2 ;
     * 
     * model.addEventListener( ModelObjectEvent.UPDATE_VO , onUpdate ) ;
     * 
     * var datas:Array  = [] ;
     * var count:uint = 20 ;
    ...
    public class PageableArrayModelObject extends CoreModelObject
    {
         ...
         */
        public function PageableArrayModelObject(id:* = null, global:Boolean = false, channel:String = null)
        {
