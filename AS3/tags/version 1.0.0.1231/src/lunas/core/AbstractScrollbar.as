...
package lunas.core 
{
	...
	public class AbstractScrollbar extends AbstractProgressbar implements IScrollbar
	{
		 ...
		 */
		public function AbstractScrollbar( direction:String = "vertical", id:* = null, isConfigurable:Boolean = false, name:String = null )
		{
			super( direction, id, isConfigurable, name ) ;
		}
