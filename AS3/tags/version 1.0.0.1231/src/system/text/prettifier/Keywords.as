...
package system.text.prettifier
{
    ...
    public class Keywords
    {
         ...
         * @private
         */
        private static var _k:Object = { a:[] , b:[] , c:[] , d:[] , e:[] , f:[] , g:[] , h:[] , i:[] , j:[] , k:[] , l:[] , m:[] , n:[] , o:[] , p:[] , q:[] , r:[] , s:[] , t:[] , u:[] , v:[] , w:[] , x:[] , y:[] , z:[] };
        ...
        public static function list( letter:String = "" ):Array
        {
            ...
            {
                var _all:Array = [];
                _all.concat( _k.a, _k.b, _k.c, _k.d, _k.e, _k.f, _k.g, _k.h, _k.i, _k.j, _k.k, _k.l, _k.m, _k.n, _k.o, _k.p, _k.q, _k.r, _k.s, _k.t, _k.u, _k.v, _k.w, _k.x, _k.y, _k.z );
