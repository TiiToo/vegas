...
package lunas.components.bars
{
    ...
    public class CoreProgressbar extends CoreProgress implements Progressbar 
    {
         ...
         * @param w The prefered width of the button (default 150 pixels).
         * @param h The prefered height of the button (default 6 pixels).
         */
        public function CoreProgressbar( direction:String = "horizontal", w:Number = 150 , h:Number = 6 )
        {
            lock() ;
            super() ;
