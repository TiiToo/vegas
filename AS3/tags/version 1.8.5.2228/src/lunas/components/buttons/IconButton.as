...
package lunas.components.buttons 
{
    ...
    public class IconButton extends LabelButton implements Iconifiable
    {
         ...
         */
        public function IconButton( w:Number = 120 , h:Number = 20 )
        {
            super( w , h ) ;
        }
        ...
        {
            return (style as IconButtonStyle).iconAlign ;
        }
        ...
        {
            (style as IconButtonStyle).iconAlign = value ;
            update() ;
        }
