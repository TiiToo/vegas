...
package lunas.components.buttons
{
    ...
    public class BackgroundButtonStyle extends CoreStyle 
    {
        ...
        public override function initialize():void 
        {
            ...
            tweenOver           = new TweenTo( null , { brightness : 0 } , Back.easeOut    , 1   , true  , false, { brightness : 125 } ) ;
            tweenSelected       = new TweenTo( null , { brightness : 0 } , Elastic.easeOut , 0.5 , true  , false, { brightness : 100 } ) ;
        }
    }
}
