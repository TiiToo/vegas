...
package lunas.components.buttons 
{
     ...
     */
    public class BitmapFilterButton extends FrameLabelButton 
    {
        /**
        ...
        /**
         * Returns the <code class="prettyprint">Builder</code> class of this instance.
         * @return the <code class="prettyprint">Builder</code> class of this instance.
         */
        public override function getBuilderRenderer():Class
        {
            return BitmapFilterButtonBuilder ;
        }
        ...
        {
            return BitmapFilterButtonStyle ;
        }
    }
}
