...
package lunas.components.textinputs 
{
     ...
     */
    public class CoreTextInput extends CoreComponent implements TextInput
    {
        /**
         ...
         */ 
        public function CoreTextInput( id:* = null, isFull:Boolean=false, name:String = null)
        {
        ...
        public function set textField( field:TextField ):void
        {
            ...
            _textField = field || new TextField() ; // the field not must be null.
            if ( _textField != null )
            {
               addChild(_textField) ;
