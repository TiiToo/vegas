...
package system
{
    ...
    public class Strings
         ...
         * <pre class="prettyprint">{0}, {1}, ..., {99}, etc.</pre>
         * <p>But <b>_evaluate</b> need to sync its indexes with the _format _indexes so we pick an arbitrary number: 100
         * officially indexed token can go from {0} to {99} to avoid a conflict with that arbitrary number.
         * @private
         */
        ...
        private static function _evaluate( value:String ):Object
            ...
            while( value.indexOf( "${" ) > -1 )
                ...
                if( lpos != evalSequence.length-1 )
                    ...
                    var len:uint = evaluatorsAlias.length ;
                    for( var i:uint = 0; i<len; i++ )
                        {
                        if( evaluatorsAlias[i] in Strings.evaluators  )
                            {
                ...
                obj.indexes.push( _evaluateHelper( evalString  , evaluators ) );
         ...
         * @private
         */
        private static function _evaluateHelper( expression:* , evaluators:Array ):String
            {
            var len:uint = evaluators.length ;
            for( var i:uint = 0; i < len; i++ )
                {
        ...
        private static function _format( stringvalue:String, indexed:Array, named:Object, paddingChar:String = " " ):String
            ...
            // TODO to {0,5} {0,-5} add something like {0,~5} to support padding to center 
         ...
         * @private
         */
        private static function _isValid( str:String ):Boolean
            {
            if( str == "" )
                {
                return true;
         ...
         * @private
         */
        private static function _isValidChar( c:String ):Boolean
            {
        ...
        /**
         * Contains a list of evaluators to be used in Strings.format
         * 
         * ex:
        ...
        public static function format( format:String, ...args ):String
            ...
            var len:uint = evaluated.indexes.length ;
            for( var i:uint = 0; i<len ; i++ )
                {
