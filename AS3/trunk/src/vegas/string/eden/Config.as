...
package vegas.string.eden
{
	...
	public class Config
	{
	     ...
	     * 		ex: "toto.titi.*"
	     * 
	     * the difference is with a full path you can only create/use/define/assign value to this exact path
	     * and with a starting path you can create/use/define/assign value to this path and its child paths
	     * 
	     * attention:
	     ...
	     *  
	     * with allowFunctionCall=true 'toto' will equal "HELLO WORLD"
