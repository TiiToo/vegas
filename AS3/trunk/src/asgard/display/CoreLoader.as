...
package asgard.display 
{
	...
	/**
	 * The CoreLoader class extends the flash.display.Loader class and implements the Identifiable interface.
	 * @author eKameleon
	 */
	public class CoreLoader extends Loader implements IConfigurable, Identifiable, ILockable 
	{
