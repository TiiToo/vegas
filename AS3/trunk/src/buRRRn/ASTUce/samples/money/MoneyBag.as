...
package buRRRn.ASTUce.samples.money
     ...
     * For example adding 12 euros to 14 US Dollars is represented as a bag containing the two Monies 12€ and 14$.
    ...
    public class MoneyBag implements IMoney
        ...
        */
        public static function create( m1:IMoney, m2:IMoney ):IMoney
            {
            var result:MoneyBag = new MoneyBag();
