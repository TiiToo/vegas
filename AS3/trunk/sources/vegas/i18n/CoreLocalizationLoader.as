...
package vegas.i18n
{
    ...
    public class CoreLocalizationLoader extends ActionURLLoader implements ILocalizationLoader
    {
         ...
         */
        public function CoreLocalizationLoader( localization:Localization = null , loader:URLLoader = null)
        {
            super( loader ) ;
        ...
        public override function parse():void
        {
            if ( data != null )
            {
                ...
                {
                    warn( this + " parse error : append the current Localization failed, the current Lang value not must be 'null' or 'undefined'." )    ;
                }
            }
            else
            {
                warn( this + " parse error : append the current Localization failed, the external object date value not must be 'null' or 'undefined'." )   ;
            }
        }
