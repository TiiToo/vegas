...
package vegas.i18n 
{
    ...
    public class Localization extends CoreEventDispatcher implements Identifiable
    {
        ...
        /**
         * Returns a <code class="prettyprint">Localization</code> singleton reference with the specified id passed-in argument.
         * @return a <code class="prettyprint">Localization</code> singleton reference with the specified id passed-in argument.
         */
        ...
        public function getLocale( id:String=null ):* 
        {
            ...
            {
                var item:Locale = this.get( _current ) ;
                if ( item != null ) 
                {
                    item.throwError = throwError ;
                    return item.get( id ) ;
                }
                else
                {
