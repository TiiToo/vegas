...
package vegas.media.subtitles
{
    ...
    public class Captions
    {
         ...
         */
        public function Captions( captions:Vector.<Caption> )
        {
         ...
         * @param time The time in seconds to find a Caption object.
         * @return A Caption object if it's find in the Vector of captions with the passed-in time value.
         */
