...
package examples
{
    ...
    [SWF(width="740", height="480", frameRate="24", backgroundColor="#000000")]
    // -static-link-runtime-shared-libraries=true -target-player={playerVersion}
    
    public class StageVideoExpertExample extends Sprite
    {
        public function StageVideoExpertExample()
        {
            ///// stage
            ...
            streamExpert.status.connect( status ) ;
        }
        ...
        protected function keyDown( e:KeyboardEvent ):void
        {
            ...
            switch( code ) 
            {
                ...
                {
                    streamExpert.close() ;
                    streamExpert.play( "videos/comp1.f4v") ;
                    break ;
                }
                case Keyboard.DOWN :
                {
                    streamExpert.close() ;
                    streamExpert.play( "videos/comp2.f4v") ;
                    break ;
                }
            }
        }
