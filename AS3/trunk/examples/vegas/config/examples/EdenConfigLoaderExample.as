...
package examples 
{
    ...
    /**
     * Example of the EdenConfigLoader class.
     */
    public class EdenConfigLoaderExample extends Sprite 
    {
        public function EdenConfigLoaderExample()
        {
            var loader:EdenConfigLoader = new EdenConfigLoader() ;
