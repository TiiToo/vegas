...
package pegas.geom 
{
	...
	public class TestVertex extends TestCase 
	{
		...
		public function TestVertex(name:String = "")
		{
			super( name );
		}
        ...
        public function testConstructor():void
        {
            ...
            assertTrue( v is Vertex, "VERTEX_00_02 - constructor is an instance of Vertex.") ;
        }
        
        public function testInherit():void
        {
            assertTrue( v is Vector3 , "VERTEX_01 - inherit Vector3 failed.") ;
        }   
        ...
        public function testGetTransformVector3():void
        {
            ...
            assertTrue(tv is Vector3, "VERTEX_16_01 - getTransformVector3() method failed.") ;
        ...
        public function testGetWorldVector3():void
        {
            ...
            assertTrue(wv is Vector3, "VERTEX_17_01 - getWorldVector3() method failed.") ;
        ...
        public function testClone():void
        {
            ...
            clone.wy = 10000 ;
            clone.wz = 11000 ;
            assertTrue( clone is Vertex , "VERTEX_18 - clone method failed, must return a Vertex reference." ) ;
        ...
        public function testCopy():void
        {
            ...
            copy.wy = 10000 ;
            copy.wz = 11000 ;
            assertTrue( copy is Vertex , "VERTEX_19 - copy method failed, must return a Vertex reference." ) ;
