...
package andromeda.ioc.evaluators 
{
    ...
    public class TypeEvaluatorTest extends TestCase 
    {
        ...
        /**
         * Creates a new TypeEvaluatorTest instance.
         */
        ...
        public function testEvaluator1():void
        {
            ...
            assertEquals( evaluator1.eval("vegas.core.CoreObject") , CoreObject , "evaluator1.eval('vegas.core.CoreObject') failed.") ;
        }  
