...
package vegas.net.remoting 
{
    ...
    {
        public function RemotingGatewayUrlTest(name:String = "")
        {
            super( name );
        }
        ...
        {
            assertEquals( "httpHost" , factory.httpHostName ) ;
        }
        
        public function testUrlName():void
        {
            assertEquals( "gatewayUrl" , factory.urlName ) ;
        }
        
        public function testCreate():void
        {
            assertEquals( "http://localhost/test.php" , factory.create( "http://{0}/test.php" , "localhost" ) ) ;
        }
