<?php
    ...
    */
    ...
    require_once( realpath( dirname( __FILE__ ) . "/Cloneable.php") ) ;
    require_once( realpath( dirname( __FILE__ ) . "/Iterable.php") ) ;
    require_once( realpath( dirname( __FILE__ ) . "/Serializable.php") ) ;
     ...
     *
     */
    interface Map extends Cloneable, Iterable, Serializable
    {
        /**
