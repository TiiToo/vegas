 ...
 * 
 * var hash = SHA1.encrypt("hello world") ;
 * var equal = hash == '2aae6c35c94fcfb415dbe95f408b9ce91ee846ed' ;
 * 
 ...
 * @author eKameleon
 */
if ( calista.hash.SHA1 == undefined ) 
{

	/**
	 * Creates the SHA1 singleton.
	 */
	calista.hash.SHA1 = {} ;
	 ...
	 * Encrypt the specified text with the SHA1 algorithm.
 	 ...
 	 * }
	 */
	calista.hash.SHA1.encrypt = function( message /*String*/ ) /*String*/
	{
		
		var SHA1 = calista.hash.SHA1 ;
	 ...
	 * @private
	 */
	calista.hash.SHA1.f = function( s /*Number*/, x /*Number*/ , y/*Number*/ , z /*Number*/ ) /*Number*/ 
	{
    	switch (s) 
    	{
	 ...
	 * @private
	 */
	calista.hash.SHA1.ROTL = function( x /*Number*/, n /*Number*/ ) /*Number*/ 
	{
		return ( x<<n ) | ( x >>> (32-n) );
	}
	/**
	 ...
	 * @private
	 */
	calista.hash.SHA1.toHexStr = function( n /*Number*/ ) /*String*/ 
	{
		var s /*String*/ = "" ;
	    var v /*Number*/ ;
    	for ( var i=7 ; i>=0 ; i-- ) 
