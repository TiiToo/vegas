 ...
 * <p><b>Example :</b></p>
 * {@code
 * LZW = calista.util.LZW ;
 * 
 * var source = "hello world with LZW algorithm" ;
 * 
 * var compress = LZW.compress( source ) ;
 ...
 * @author eKameleon
 */
if ( calista.util.LZW == undefined ) 
{

	/**
	 * Creates the LZW singleton.
	 */
	calista.util.LZW = {} ;
	 ...
	 * Compresses the specified text.
 	 ...
 	 * }
	 */
	calista.util.LZW.compress = function( str /*String*/ ) /*String*/
	{
		var i/*Number*/    ;
		var size/*Number*/ ;
		var xstr /*String*/;
	 ...
	 * Decompresses the specified text with the LZW algorithm.
 	 ...
 	 * }
	 */
	calista.util.LZW.decompress = function( str /*String*/ ) /*String*/
	{
		var i /*Number*/ ;
		var chars /*Number*/ = 256;
		var dict /*Array*/ = new Array();
