 ...
 * @author eKameleon
 */
if (vegas.logging.errors.InvalidFilterError == undefined) 
{
	 ...
	 */
	vegas.logging.errors.InvalidFilterError = function( message /*String*/ , e /*ErrorElement*/ ) 
	{
	 ...
	 */
	vegas.logging.errors.InvalidFilterError.extend( vegas.errors.FatalError ) ;
