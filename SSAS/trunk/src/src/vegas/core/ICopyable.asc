 ...
 * @author eKameleon
 */
if (vegas.core.ICopyable == undefined) 
{

	vegas.core.ICopyable = function () {}
	
	/**
	 * @extends vegas.core.CoreObject
	 */
	vegas.core.ICopyable.extend(vegas.core.CoreObject) ;

	/**
	 * Creates and returns a deep copy of the object.
	 * @return A new object that is a deep copy of this instance.
	 */	
	vegas.core.ICopyable.prototype.copy = function() 
	{
		//
	}
