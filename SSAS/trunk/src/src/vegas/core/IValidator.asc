 ...
 * @author eKameleon
 */
if (vegas.core.IValidator == undefined) 
{

	vegas.core.IValidator = function () 
	{ 
		//
	}
	 ...
	 */
	vegas.core.IValidator.extend(vegas.core.CoreObject) ;

	/**
	 * Returns true if the IValidator object validate the value.
	 * @return {@code true} is this specific value is valid.
	 */
	vegas.core.IValidator.prototype.supports = function(value) /*Boolean*/ 
	{
		//
	}
	 ...
	 */
	vegas.core.IValidator.prototype.validate = function (value) /*Void*/ 
	{
		//
	}
