 ...
 * @author eKameleon
 */
if (vegas.core.IFormat == undefined) 
{

	vegas.core.IFormat = function () {}

	/**
	 * @extends vegas.core.CoreObject
	 */
	vegas.core.IFormat.extend(vegas.core.CoreObject) ;

	/**
	 * Converts the object to a custom string representation.
	 */	
	vegas.core.IFormat.prototype.formatToString = function(o) /*String*/ 
	{
		//
	}
