 ...
 */
if (vegas.core.ISerializable == undefined) 
{

	vegas.core.ISerializable = function () {}

	/**
	 * @extends vegas.core.CoreObject
	 */
	vegas.core.ISerializable.extend(vegas.core.CoreObject) ;
	 ...
	 */
	vegas.core.ISerializable.prototype.toSource = function(indent/*Number*/, indentor/*String*/) /*String*/ 
	{
		//
	}
