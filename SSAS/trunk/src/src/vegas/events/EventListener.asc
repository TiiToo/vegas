 ...
 * @author eKameleon
 */
if (vegas.events.EventListener == undefined) 
{

	/**
	 * Creates a new EventListener instance.
	 */
	vegas.events.EventListener = function () 
	{ 
	 ...
	 */
	vegas.events.EventListener.extend(vegas.core.CoreObject) ;
	
	/**
	 * This method is called whenever an event occurs of the type for which the EventListener interface was registered.
	 * @param e The Event contains contextual information about the event.
	 */
	vegas.events.EventListener.prototype.handleEvent = function ( e /*Event*/ ) 
	{
