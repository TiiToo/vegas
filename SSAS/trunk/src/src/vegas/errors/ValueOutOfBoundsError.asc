 ...
 * @author eKameleon
 */
if (vegas.errors.ValueOutOfBoundsError == undefined) 
{
	 ...
	 */
	vegas.errors.ValueOutOfBoundsError = function( message /*String*/ , e /*ErrorElement*/ ) 
	{
	 ...
	 */
	vegas.errors.ValueOutOfBoundsError.extend( vegas.errors.FatalError ) ;
