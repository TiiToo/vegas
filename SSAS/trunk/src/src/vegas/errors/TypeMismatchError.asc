 ...
 * @author eKameleon
 */
if (vegas.errors.TypeMismatchError == undefined) 
{
	 ...
	 */
	vegas.errors.TypeMismatchError = function( message /*String*/ , e /*ErrorElement*/ ) 
	{
	 ...
	 */
	vegas.errors.TypeMismatchError.extend( vegas.errors.FatalError ) ;
