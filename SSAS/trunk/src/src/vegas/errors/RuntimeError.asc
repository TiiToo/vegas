 ...
 * @author eKameleon
 */
if (vegas.errors.RuntimeError == undefined) 
{
	 ...
	 */
	vegas.errors.RuntimeError = function( message /*String*/ , e /*ErrorElement*/ ) 
	{
	 ...
	 */
	vegas.errors.RuntimeError.extend( vegas.errors.FatalError ) ;
