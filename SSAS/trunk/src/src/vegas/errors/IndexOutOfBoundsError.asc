 ...
 * @author eKameleon
 */
if (vegas.errors.IndexOutOfBoundsError == undefined) 
{
	 ...
	 */
	vegas.errors.IndexOutOfBoundsError = function( message /*String*/ , e /*ErrorElement*/ ) 
	{
	 ...
	 */
	vegas.errors.IndexOutOfBoundsError.extend( vegas.errors.FatalError ) ;
