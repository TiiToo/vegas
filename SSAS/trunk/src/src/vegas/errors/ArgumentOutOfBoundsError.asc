 ...
 * @author eKameleon
 */
if (vegas.errors.ArgumentOutOfBoundsError == undefined) 
{
	 ...
	 */
	vegas.errors.ArgumentOutOfBoundsError = function( message /*String*/ , e /*ErrorElement*/ ) 
	{
	 ...
	 */
	vegas.errors.ArgumentOutOfBoundsError.extend( vegas.errors.FatalError ) ;
