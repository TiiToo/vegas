 ...
 * @author eKameleon
 */
if (vegas.errors.IllegalArgumentError == undefined) 
{
	 ...
	 */
	vegas.errors.IllegalArgumentError = function( message /*String*/ , e /*ErrorElement*/ ) 
	{
	 ...
	 */
	vegas.errors.IllegalArgumentError.extend( vegas.errors.FatalError ) ;
