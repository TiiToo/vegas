 ...
 * @author eKameleon
 */
if (vegas.errors.ArgumentsError == undefined) 
{
	 ...
	 */
	vegas.errors.ArgumentsError = function( message /*String*/ , e /*ErrorElement*/ ) 
	{
	 ...
	 */
	vegas.errors.ArgumentsError.extend( vegas.errors.FatalError ) ;
