 ...
 */
core.dumpObject = function( value /*Object*/ , prettyprint /*Boolean*/ , indent /*int*/ , indentor /*String*/  ) /*String*/
{
    ///////////
    ...
    for( var member /*String*/ in value )
    {
        if( value.hasOwnProperty( member ) )
        {
            ...
            source.push( member + ":" + core.dump( value[ member ], prettyprint, indent, indentor ) );
