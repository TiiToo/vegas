 ...
 * } ;
 * 
 * result = core.arrays.reduceRight( ar , callback ) ;
 * 
 ...
 * 
 * result = core.arrays.reduceRight( ar , callback , 10 ) ;
 * 
 ...
 */
core.arrays.reduceRight = function( ar /*Array*/ , callback /*Function*/ , initialValue )
{
    var size /*int*/ = ar.length ;
    if ( callback == null )
    {
        throw new Error("core.arrays.reduceRight() function failed, the callback method not must be null.") ;
    }
    if ( size == 0 )
    {
        throw new Error("core.arrays.reduceRight() function failed, the passed-in array is empty.") ;
    }
    var i /*int*/ = size - 1 ;
    var r ;
