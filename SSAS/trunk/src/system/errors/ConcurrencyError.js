 ...
 */
if ( system.errors.ConcurrencyError == undefined ) 
{
    /**
     * Creates a new ConcurrencyError instance.
     */
    system.errors.ConcurrencyError = function( message /*String*/ ) 
    {
     ...
     * @extends Error
     */
    proto = system.errors.ConcurrencyError.extend( Error ) ;
    ...
    {
        return "new system.errors.ConcurrencyError(" + this.message.toSource() + ")" ;
    }
