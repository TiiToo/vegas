 ...
 */
if ( system.errors.InvalidChannelError == undefined ) 
{
    /**
     * Creates a new InvalidChannelError instance.
     */
    system.errors.InvalidChannelError = function( message /*String*/ ) 
    {
     ...
     * @extends Error
     */
    proto = system.errors.InvalidChannelError.extend( Error ) ;
    ...
    {
        return "new system.errors.InvalidChannelError(" + this.message.toSource() + ")" ;
    }
