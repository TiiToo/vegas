...
if (outfile)
{
  ...
  out.writeln("TD {margin-left=10px; margin-top=0px; margin-bottom=3px; font:10pt/12pt Helvetica,Arial,sans-serif; vertical-align:top}");
...
sidebar.writeln('href="http://developer.mozilla.org/En/Core_JavaScript_1.5_Reference:Global_Objects:Array"')
sidebar.writeln('title="Core JavaScript 1.5 Reference:Global Objects:Array">Array</a>')
sidebar.writeln('</li>')
sidebar.writeln('<li><a')
sidebar.writeln('href="http://developer.mozilla.org/En/Core_JavaScript_1.5_Reference:Global_Objects:Boolean"')
sidebar.writeln('title="Core JavaScript 1.5 Reference:Global Objects:Boolean">Boolean</a>')
sidebar.writeln('</li>')
sidebar.writeln('<li><a')
sidebar.writeln('href="http://developer.mozilla.org/En/Core_JavaScript_1.5_Reference:Global_Objects:Date"')
sidebar.writeln('title="Core JavaScript 1.5 Reference:Global Objects:Date">Date</a>')
sidebar.writeln('</li>')
sidebar.writeln('<li><a')
sidebar.writeln('href="http://developer.mozilla.org/En/Core_JavaScript_1.5_Reference:Global_Objects:Function"')
sidebar.writeln('title="Core JavaScript 1.5 Reference:Global Objects:Function">Function</a>')
sidebar.writeln('</li>')
sidebar.writeln('<li><a')
sidebar.writeln('href="http://developer.mozilla.org/En/Core_JavaScript_1.5_Reference:Global_Objects:Math"')
sidebar.writeln('title="Core JavaScript 1.5 Reference:Global Objects:Math">Math</a>')
sidebar.writeln('</li>')
sidebar.writeln('<li><a')
sidebar.writeln('href="http://developer.mozilla.org/En/Core_JavaScript_1.5_Reference:Global_Objects:Number"')
sidebar.writeln('title="Core JavaScript 1.5 Reference:Global Objects:Number">Number</a>')
sidebar.writeln('</li>')
sidebar.writeln('<li><a')
sidebar.writeln('href="http://developer.mozilla.org/En/Core_JavaScript_1.5_Reference:Global_Objects:Object"')
sidebar.writeln('title="Core JavaScript 1.5 Reference:Global Objects:Object">Object</a>')
sidebar.writeln('</li>')
sidebar.writeln('<li><a')
sidebar.writeln('href="http://developer.mozilla.org/En/Core_JavaScript_1.5_Reference:Global_Objects:RegExp"')
sidebar.writeln('title="Core JavaScript 1.5 Reference:Global Objects:RegExp">RegExp</a>')
sidebar.writeln('</li>')
sidebar.writeln('<li><a')
sidebar.writeln('href="http://developer.mozilla.org/En/Core_JavaScript_1.5_Reference:Global_Objects:String"')
