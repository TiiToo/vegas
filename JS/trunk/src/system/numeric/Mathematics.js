...
{
    /**
     * Creates the Mathematics singleton.
     */
     ...
     * var n = system.numeric.Mathematics.ceil(4.572525153, 2) ;
     * trace ("n : " + n) ; // n : 4.58
     * 
     * var n = system.numeric.Mathematics.ceil(4.572525153, -1) ;
     * trace ("n : " + n) ; // n : 5
     * </pre>
     ...
     */
    system.numeric.Mathematics.ceil = function( n /*Number*/ , floatCount /*Number*/ ) /*Number*/ 
    {
        if (isNaN( n )) 
        {
            return NaN ;
     ...
     * <p><b>Example :</b></p>
     * <pre class="prettyprint">
     * var n = system.numeric.Mathematics.clamp(4, 5, 10) ;
     * trace ("n : " + n) ; // 5
     * 
     * var n = system.numeric.Mathematics.clamp(12, 5, 10) ;
     * trace ("n : " + n) ; // 10
     * 
     * var n = system.numeric.Mathematics.clamp(6, 5, 10) ;
     * trace ("n : " + n) ; // 5
     * 
     * var n = system.numeric.Mathematics.clamp(NaN, 5, 10) ;
     * trace ("n : " + n) ; // NaN
     * </pre>
     ...
     * <p><b>Example :</b></p>
     * <pre class="prettyprint">
     * var n = system.numeric.Mathematics.floor(4.572525153, 2) ;
     * trace ("n : " + n) ; // n : 4.57
     * 
     * var n = system.numeric.Mathematics.floor(4.572525153, -1) ;
     * trace ("n : " + n) ; // n : 4
     * </pre>
     * @param n the number to round.
     * @param floatCount the count of number after the point.
     ...
     */
    system.numeric.Mathematics.floor = function(n /*Number*/, floatCount /*Number*/) /*Number*/ 
    {
        if (isNaN( n )) 
        {
            return NaN ;
     ...
     * <p><b>Example :</b></p>
     * <pre class="prettyprint">
     * var gcd:int = system.numeric.Mathematics.gcd(320,240) ;
     * trace("Mathematics.gcd(320,240) : " + gcd ) ; // Mathematics.gcd(320,240) : 80
     * </pre>
     ...
     */
    system.numeric.Mathematics.gcd = function( i1 /*int*/ , i2 /*int*/ ) /*int*/
    {
        if ( i2 == 0 )
        {
            return i1 ;
     ...
     * <pre class="prettyprint">
     * trace( system.numeric.Mathematics.interpolate( 0.5, 0 , 100 ) ) ; // 50
     * </pre>
     ...
     */
    system.numeric.Mathematics.interpolate = function( value /*Number*/, minimum /*Number*/, maximum /*Number*/ ) /*Number*/
    {
     ...
     * <pre class="prettyprint">
     * trace( system.numeric.Mathematics.map( 10,  0, 100, 20, 80  ) ) ; // 26
     * trace( system.numeric.Mathematics.map( 26, 20,  80,  0, 100 ) ) ; // 10
     * </pre>
     ...
     * <pre class="prettyprint">
     * trace( system.numeric.Mathematics.normalize( 10, 0 , 100 ) ) ; // 0.1
     * </pre>         
     * @param value The number value to normalize.
     * @param minimum The minimum value of the normalization.
     * @param maximum The maximum value of the normalization.
     */
    system.numeric.Mathematics.normalize = function(value /*Number*/, minimum /*Number*/, maximum /*Number*/) /*Number*/
    {
     ...
     * <p><b>Example :</b></p>
     * <pre class="prettyprint">
     * trace( system.numeric.Mathematics.percentage( 50 , 100 ) + "%" ) ; // 50%
     * trace( system.numeric.Mathematics.percentage( 68 , 425 ) + "%" ) ; // 16% 
     * </pre>
     * @param value the current value.
     * @param maximum the max value.
     * @return a percentage value or null.
     */
    system.numeric.Mathematics.percentage = function(value /*Number*/ , maximum /*Number*/ ) /*Number*/ 
    {
     ...
     * <p><b>Example :</b></p>
     * <pre class="prettyprint">
     * var n = system.numeric.Mathematics.round(4.572525153, 2) ;
     * trace ("n : " + n) ; // 4.57
     * 
     * var n = system.numeric.Mathematics.round(4.572525153, -1) ;
     * trace ("n : " + n) ; // 5
     * </pre>
     * @param n the number to round.
     * @param floatCount the count of number after the point.
     ...
     */
    system.numeric.Mathematics.round = function( n /*Number*/, floatCount /*Number*/ ) /*Number*/ 
    {
        if (isNaN( n )) 
        {
            return NaN ;
     ...
     * <p><b>Example :</b></p>
     * <pre class="prettyprint">
     * n = system.numeric.Mathematics.sign(-150) ;
     * trace ("n : " + n) ; // -1
     * 
     * n = system.numeric.Mathematics.sign(200) ;
     * trace ("n : " + n) ; // 1
     * 
     * n = system.numeric.Mathematics.sign(0) ;
     * trace ("n : " + n) ; // 1
     * </pre>
