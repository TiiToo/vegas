 ...
 */
if ( system.errors.NoSuchElementError == undefined ) 
{
    /**
     * Creates a new NoSuchElementError instance.
     */
    system.errors.NoSuchElementError = function( message /*String*/ ) 
    {
     ...
     * @extends Error
     */
    proto = system.errors.NoSuchElementError.extend( Error ) ;
    ...
    {
        return "new system.errors.NoSuchElementError(" + this.message.toSource() + ")" ;
    }
