 ...
 * trace( core.strings.trimStart("---hello world---" , Strings.whiteSpaceChars.concat("-") ) ); // hello world---
 * </pre>
 ...
 */
core.strings.trimStart = function( source /*String*/ , chars /*Array*/ ) /*String*/ 
{
    if( chars == null )
    {
        chars = core.strings.whiteSpaceChars ;
    }
