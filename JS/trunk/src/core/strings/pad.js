 ...
 * var word = "hello";
 * 
 * trace( "[" + core.strings.pad( word, 8 ) + "]" ); //align to the right
 * trace( "[" + core.strings.pad( word, -8 ) + "]" ); //align to the left
 * 
 * //output
 * //[   hello]
 * //[hello   ]
 ...
 * for( var i = 0 ; i<len ; i++ )
 * {
 *     trace( core.strings.pad( seinfeld[i] , 10 , "." ) ) ;
 * }
 * 
 * //output
 * //.....jerry
 ...
 */
core.strings.pad = function( source /*String*/ , amount /*int*/ , ch /*String*/ ) /*String*/ 
{
    if ( source == null )
    {
        return "" ;
