dynamic intrinsic class MovieClip
{
	...
	function getURL(url:String,optionalWindow:String,optionalMethod:String):Void;
	function unloadMovie():Void;
	function loadVariables(url:String,optionalMethod:String):Void;
	function loadMovie(url:String,optionalMethod:String):Void;
	function attachMovie(id:String,name:String,depth:Number,optionalInitObject:Object):MovieClip;
	...
	function duplicateMovieClip(name:String,depth:Number,optionalInitObject:Object):MovieClip;
	function removeMovieClip():Void;
	function startDrag(lockCenter:Boolean,optionalLeft:Number,optionalTop:Number,optionalRight:Number,optionalBottom:Number):Void;
	function stopDrag():Void;
	function createEmptyMovieClip(name:String,depth:Number):MovieClip;
	function beginFill(rgb:Number,optionalAlpha:Number):Void;
	...
	function lineStyle(thickness:Number,optionalRgb:Number,optionalAlpha:Number):Void;
