...
/**
 * XMLSocket extension for SOS LogClients
 * 
 * @author Nico Zimmermann nz@powerflasher.de
 * @version $Id$
 */
class org.sos.core.LogSocket extends AbstractSocket {

	/**
	 * Connects to SOS Logport. <br>
	 * The Sockethost is 'localhost', the port ist set by Env.getLogPort
	 * overrides XMLSocket
	 * 
	 * @see org.sos.core.Env
	 */
	public function connect(Void) : Void {
		super.connect("localhost", Env.getLogPort());
	}
