...
class vegas.util.ConstructorUtil 
{
	 ...
	 * 
	 * var clazz:Function = ConstructorUtil.createConstructorByNamespace("vegas.core.CoreObject") ;
	 * 
	 ...
	 */
    public static function createConstructorByNamespace( path:String , scope )
	{
