 ...
 * @author eKameleon
 */
class andromeda.ioc.core.ObjectDefinition extends CoreObject implements IObjectDefinition 
{
	 ...
	 */	
	public function ObjectDefinition( type:String , singleton:Boolean ) 
	{
