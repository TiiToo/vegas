 ...
 * @author eKameleon
 */
class pegas.draw.LineStyle extends CoreObject implements ILineStyle 
{
     ...
     */
	public function LineStyle( thickness:Number , color:Number, alpha:Number, pixelHinting:Boolean, scaleMode:String, caps:String, joints:String, miterLimit:Number )
	{
        this.thickness    = thickness;
        this.color        = isNaN(color) ? 0   : color ;
        this.alpha        = isNaN(alpha) ? 100 : alpha ;
        this.pixelHinting = pixelHinting;
        this.scaleMode    = scaleMode == null ?  "normal" : scaleMode ;
        this.caps         = caps;
        this.joints       = joints;
        this.miterLimit   = isNaN(miterLimit) ? 3 : miterLimit ;
	}

	/**
     * The empty LineStyle singleton.
     */
    public static var EMPTY:LineStyle = new LineStyle() ;
