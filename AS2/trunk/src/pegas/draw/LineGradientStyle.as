 ...
 * @author eKameleon
 */
class pegas.draw.LineGradientStyle extends CoreObject implements ILineStyle 
{
     ...
     */
	public function LineGradientStyle( type:String, colors:Array, alphas:Array, ratios:Array, matrix:Matrix, spreadMethod:String, interpolationMethod:String , focalPointRatio:Number )
	{
        this.alphas              = alphas ;
        this.colors              = colors ;
        this.focalPointRatio     = isNaN(focalPointRatio) ? 0 : focalPointRatio ;
        this.interpolationMethod = interpolationMethod == null ? "rgb" : interpolationMethod ;
        this.matrix              = matrix ;
        this.ratios              = ratios ;
        this.spreadMethod        = spreadMethod == null ? "pad" : spreadMethod ;
        this.type                = type   ;
	}
