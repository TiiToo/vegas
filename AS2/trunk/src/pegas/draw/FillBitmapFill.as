 ...
 * @author eKameleon
 */
class pegas.draw.FillBitmapFill extends CoreObject implements IFillStyle 
{
     ...
     */
	public function FillBitmapFill( bitmap:BitmapData , matrix:Matrix , repeat:Boolean , smooth:Boolean )
	{
       this.bitmap  = bitmap ;
       this.matrix  = matrix ;
       this.repeat  = repeat ;
