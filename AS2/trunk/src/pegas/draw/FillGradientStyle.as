 ...
 * @author eKameleon
 */
class pegas.draw.FillGradientStyle extends CoreObject implements IFillStyle
{
     ...
     */
	public function FillGradientStyle( type:String, colors:Array, alphas:Array, ratios:Array, matrix:Matrix , spreadMethod:String , interpolationMethod:String , focalPointRatio:Number )  
	{
       this.alphas              = alphas ;
       this.colors              = colors ;
