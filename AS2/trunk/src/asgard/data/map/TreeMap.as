...
import asgard.data.map.SubTreeMap;
import asgard.data.map.TreeMapNode;
import asgard.data.map.TreeMapSet;
 ...
 * @author eKameleon
 */
class asgard.data.map.TreeMap extends CoreObject implements SortedMap, ICloneable, Iterable 
{
