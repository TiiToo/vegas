...
/** Point
	...
	DESCRIPTION
		...
		Class polymorphe avec la classe flash.geom.Point
	...
	METHOD SUMMARY
		...
		- getMiddle(p1:Point, p2:Point):Point
		
		- getNormal():Point
		
			renvoi la normale d'un vecteur
		...
		- plusNew(p:Object):Point
		
			remplace la fonction add de la classe flash.geom.Point() (MTASC compatibility)
		...
		- scaleNew(s:Number):Point
		
		- setAngle(n:Number):Void
		
		- setLength(n:Number:Void
		
		- subtract(p:Object):Void
		
		- subtractNew(p:Point):Point
	...
	IMPLEMENTS
		...
		ICloneable, IEquality, ISerializable, IFormattable, IHashable
