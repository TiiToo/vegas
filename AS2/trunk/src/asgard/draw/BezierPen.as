...
/** BezierPen
	...
	CONSTRUCTOR
		...
		var b:Pen = new BezierPen(target:MovieClip, isNew:Boolean) ;
	...
	METHOD SUMMARY
		...
		+ draw(p1:Point, p2:Point, p3:Point, p4:Point, tolerance:Number):Void
		
		+ drawCubicBezier(p0:Point, p1:Point, p2:Point, p3:Point, nSegment:Number, moveto:Boolean):Number
		
		+ drawCubicBezier2(p0, p1, p2, p3):Void
		
		+ drawCubicBezierSpline(p0:Point, p1:Point, p2:Point, p3:Point):Void
		
		+ drawPoints(p1:Point, p2:Point, p3:Point, p4:Point, tolerance:Number):Void
		...
		+ simulate(p1:Point, p2:Point, p3:Point, p4:Point):Void
		
			More speed method
		
		+ sliceCubicBezierSegment(p0:Point, p1:Point, p2:Point, p3:Point, u1, u2, tu1, tu2, recurs:Number):Number
		
		- toString():String
	
	INHERIT
	
		AbstractPen > BezierPen
