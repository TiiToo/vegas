...
import lunas.display.abstract.AbstractTextAreaDisplay;
...
/**
 * This class simplify the implementation of the TextInputDisplay components.
 * @author eKameleon
 */
class lunas.display.abstract.AbstractTextInputDisplay extends AbstractTextAreaDisplay 
{
	...
	/*override*/ public function unregisterField():Boolean
	{
		if (field != null)
		{
			delete field.onKillFocus  ;
			delete field.onSetFocus  ;
			return super.unregisterField() ;
		}
		else
		{
			return false ;		
