...
class lunas.display.container.CircleContainerDisplay extends SimpleContainerDisplay 
{
    ...
    /**
     * The rotation property name use in the container to layout all items.
     */
    public var propRotation:String = "_rotation" ;
    ...
    public function changeChildsPosition():Void 
    {
        ...
        for (var i:Number = 0 ; i<l ; i++) 
        {
            ...
            if ( childOrientation )
            {
                child[propRotation] = Trigo.atan2D( child[propY] , child[propX] ) + childAngle ;
            } 
        }
    }
