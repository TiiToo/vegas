 ...
 * @author eKameleon
 */
class Tests.VegasRunner extends CoreObject implements IRunnable 
{
	
	/**
	 * Creates a new MiniRunner instance.
	 */
	public function VegasRunner( suiteName:String ) 
	{
		super();
     ...
     */
    public var printer:VegasPrinter;
