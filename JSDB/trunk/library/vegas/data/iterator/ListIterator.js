 ...
 * This iterator allows both forward and reverse iteration through the list.
 * @author eKameleon
 */
if (vegas.data.iterator.ListIterator == undefined) 
{
	 ...
	 */
	vegas.data.iterator.ListIterator = function () 
	{ 
		//	
	}
	 ...
	 */
	proto = vegas.data.iterator.ListIterator.extend(vegas.data.iterator.OrderedIterator) ;
