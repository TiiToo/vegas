 ...
 * @author eKameleon
 */
if (vegas.errors.IllegalStateError == undefined) 
{
	 ...
	 */
	vegas.errors.IllegalStateError = function( message /*String*/ , e /*ErrorElement*/ ) 
	{
	 ...
	 */
	vegas.errors.IllegalStateError.extend( vegas.errors.FatalError ) ;
