...
/* NameSpace: global
   ...
   note:
   The _global object is never used directly, and cannot be
   ...
   attention:
   The implementation and use of the _global object is different
...
_global.GetObjectPath = function( /*Object*/ target, scope )
    ...
    */
    ...
    if( scope == null )
        {
        scope = _global ; //by default the scope to scan is _global
        }
    else
        {
    ...
    */
		...
		if (ref == null)
            ...
            for( m in ref )
                ...
                */
				 ...
				 * @see $GLOBAL_PRIVATE_POLICY in core2.js file.
				 */
    ...
    for( mm in scope )
        ...
        /* attention:
           We do not want to scan _global reserved objects,
...
/* GlobalFunction: ToSource
   Allow you to dump the source of the _global Object scope.
